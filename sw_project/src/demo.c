 ...
 */
#define AUDIOCONFIG_BASEADDR	XPAR_AUDIOCONFIG_V1_0_0_BASEADDR
...
Xuint32 *baseaddr_p = (Xuint32 *) AUDIOCONFIG_BASEADDR;
...
int main(void)
{
	...
	xil_printf("----------------------------------------------------------\r\n");
	xil_printf("  Controls:\r\n");
	xil_printf("  BTN0: Start Stream\r\n");
	xil_printf("  BTN1: Toggle Automatic Gain Control\r\n");
	xil_printf("  BTN2: Stop Stream\r\n");
	xil_printf("  BTN3: Change audio mode\r\n");
	xil_printf("----------------------------------------------------------\r\n");
...
//					break;
				...
				case 'r':
					if (!Demo.fAudioRecord && !Demo.fAudioPlayback)
					{
						Demo.chBtn = 0;
						Demo.fUserIOEvent = 0;
						xil_printf("\r\nChoose Audio Configuration:\r\nBTN0: Passthrough Mode \r\nBTN1: low pass mode \r\nBTN2: high pass mode \r\nBTN3: Echo Filter\r\n");
						while(!Demo.fUserIOEvent) {}
						switch(Demo.chBtn) {
							case 'c':
								xil_printf("Set to passthrough mode...\r\n");
								*(baseaddr_p) = 0x0;
//								fnSetSampleRate(0,1,1);
//													num_samples_to_play_back = NR_AUDIO_SAMPLES;
								break;
							case 'u':
								xil_printf("Set to low pass mode...\r\n");
								*(baseaddr_p) = 0x1;
//								fnSetSampleRate(1,0,1);
//													num_samples_to_play_back = NR_AUDIO_SAMPLES*2;
								break;
							case 'l':
								xil_printf("Set to high pass mode...\r\n");
								*(baseaddr_p) = 0x2;
//								fnSetSampleRate(0,0,1);
//													num_samples_to_play_back = NR_AUDIO_SAMPLES/2;
								break;
							case 'r':
								xil_printf("Set to echo mode...\r\n");
								*(baseaddr_p) = 0x3;
//								fnSetSampleRate(0,1,1);
//													num_samples_to_play_back = NR_AUDIO_SAMPLES;
								break;
