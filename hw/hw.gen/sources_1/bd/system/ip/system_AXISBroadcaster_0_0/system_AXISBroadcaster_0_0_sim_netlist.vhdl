...
--               p:/24spring/engs128/workspace/Nestor_Jason/FinalProject-128/Zybo-Z7-10-DMA-hw.xpr/hw/hw.gen/sources_1/bd/system/ip/system_AXISBroadcaster_0_0/system_AXISBroadcaster_0_0_sim_netlist.vhdl
...
entity system_AXISBroadcaster_0_0_AXISBroadcaster is
  port (
  ...
  attribute ORIG_REF_NAME of system_AXISBroadcaster_0_0_AXISBroadcaster : entity is "AXISBroadcaster";
end system_AXISBroadcaster_0_0_AXISBroadcaster;

architecture STRUCTURE of system_AXISBroadcaster_0_0_AXISBroadcaster is
  signal S_AXIS_MM2S_tready_reg_i_1_n_0 : STD_LOGIC;
  signal S_AXIS_MM2S_tready_reg_i_2_n_0 : STD_LOGIC;
  signal S_AXIS_MM2S_tready_reg_i_3_n_0 : STD_LOGIC;
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of S_AXIS_MM2S_tready_reg : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP : string;
  attribute XILINX_TRANSFORM_PINMAP of S_AXIS_MM2S_tready_reg : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of S_AXIS_MM2S_tready_reg_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of S_AXIS_MM2S_tready_reg_i_2 : label is "soft_lutpair0";
begin
S_AXIS_MM2S_tready_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
S_AXIS_MM2S_tready_reg_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE02"
    )
        port map (
...
S_AXIS_MM2S_tready_reg_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
S_AXIS_MM2S_tready_reg_i_3: unisim.vcomponents.LUT6
    generic map(
...
entity system_AXISBroadcaster_0_0 is
  ...
  attribute NotValidForBitStream of system_AXISBroadcaster_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_AXISBroadcaster_0_0 : entity is "system_AXISBroadcaster_0_0,AXISBroadcaster,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_AXISBroadcaster_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of system_AXISBroadcaster_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of system_AXISBroadcaster_0_0 : entity is "AXISBroadcaster,Vivado 2021.2";
end system_AXISBroadcaster_0_0;

architecture STRUCTURE of system_AXISBroadcaster_0_0 is
...
U0: entity work.system_AXISBroadcaster_0_0_AXISBroadcaster
     port map (
