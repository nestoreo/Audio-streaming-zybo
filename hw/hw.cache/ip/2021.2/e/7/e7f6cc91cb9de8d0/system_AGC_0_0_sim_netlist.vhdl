...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AGC is
  ...
  signal intermediate_tready : STD_LOGIC;
  signal intermediate_tvalid : STD_LOGIC;
...
S_AXIS_DATA_tlast_reg: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
...
intermediate_tlast_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
intermediate_tready_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
intermediate_tvalid_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
