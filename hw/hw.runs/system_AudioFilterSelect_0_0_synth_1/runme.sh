...
HD_PWD='P:/24spring/engs128/workspace/Nestor_Jason/FinalProject-128/Zybo-Z7-10-DMA-hw.xpr/hw/hw.runs/system_AudioFilterSelect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_AudioFilterSelect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_AudioFilterSelect_0_0.tcl
