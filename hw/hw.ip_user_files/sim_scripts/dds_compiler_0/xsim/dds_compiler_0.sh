...
#
# Generated by Vivado on Wed May 22 18:25:57 -0400 2024
...
simulate()
{
  xsim dds_compiler_0 -key {Behavioral:sim_1:Functional:dds_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_1579.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
